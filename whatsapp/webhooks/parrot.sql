...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: ottersome
--

COPY public.users (id, name, email, country_code, phone_no, created_on, last_interaction) FROM stdin;
\.


--
-- Data for Name: utterances; Type: TABLE DATA; Schema: public; Owner: ottersome
--

COPY public.utterances (id, user_id, text, "timestamp", isbot) FROM stdin;
\.


--
-- Name: users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: ottersome
--
...
--
-- Name: utterances_id_seq; Type: SEQUENCE SET; Schema: public; Owner: ottersome
--

SELECT pg_catalog.setval('public.utterances_id_seq', 1, false);
